...
```
Менеджер проекта, аналитик данных – _Кузнецов Иван_
Инженер по машинному обучению, Full Stack-разработчик – _Казанцев Александр_
Тестировщик – _Спивак Дмитрий_
Документалист/технический писатель – _Граб Яков_
```
